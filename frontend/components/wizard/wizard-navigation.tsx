    ...
    const getNextButtonText = () => {
        switch (state.currentStep) {
            case 1:
                return "Next"
            case 2:
                return <p className="flex items-center gap-2"><Play className="w-4 h-4" /> Start Analysis</p>
            case 3:
            ...
            <div className="flex items-center gap-4">
                ...
                <Button
                    ...
                    className={cn(
                        ...
                        state.currentStep === 2 && "bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70",
                        state.currentStep === 3 && "bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600"
                    )}
                >
                    {getNextButtonText()}
                </Button>
